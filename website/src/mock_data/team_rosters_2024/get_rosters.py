...
def get_team_id_data(api_key: str):
    """gets team id data to be used to get rosters for each team, writes to team_id_2024.json"""
    ...
    #write to file
    with open("mock_data/team_rosters_2024/team_id_2024.json", "w") as f:
        json.dump(big_ten_team_data, f)


def get_team_2024_rosters(api_key: str):
